...
public class UserServiceImpl implements UserService {
    ...
    public ResponseEntity<?> save(RequestUserSaveDto dto) {
        ...
        User saveUser = userJpaRepository.save(User.builder().name(dto.getName()).username(dto.getUsername()).password(passwordEncoder.encode(dto.getPassword())).authority(UserAuthority.ROLE_USER).build());
